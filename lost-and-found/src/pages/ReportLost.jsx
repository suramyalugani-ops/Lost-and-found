...
function ReportLost() {
  ...
  const submitReport = async () => {
    try {
      ...
      // Optional: save complete submission information
      localStorage.setItem(
        "lastReport",
        JSON.stringify({
      ...
      console.log(
        "Report submitted successfully. Item ID:",
        data.item_id
      )
    ...
    <div className="min-h-screen bg-gray-50 py-6 md:py-8 px-4 md:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-4 mb-8">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm">
                ...
                {step === 2 &&
                  "Upload clear photos to help our AI match your item faster."}
          ...
          <div className="bg-red-50 border border-red-100 text-red-600 text-xs px-4 py-2 rounded-lg w-full md:max-w-xs">
            🛡{" "}
            {step === 3
              ? "Your information is safe and used only for verification."
              : "Your photos are secure and used only for matching."}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            {step === 1 && (
              <div>
                ...
                <textarea
                  ...
                  placeholder="Describe your item in detail (color, brand, size, unique marks, etc.)"
                  maxLength={500}
                ...
                <textarea
                  ...
                  placeholder="Any other information that might help (e.g., last seen with someone, event, etc.)"
                  maxLength={300}
            ...
            {step === 2 && (
              <div>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start gap-3 mb-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-400 text-sm">
                        ...
                        from different angles for better matches.
                      </p>
                  ...
                  <span className="bg-red-100 text-red-600 text-xs px-3 py-1 rounded-full whitespace-nowrap">
                    Step 2 of 3
                  </span>
                ...
                {/* Upload */}
                <label className="w-full border-2 border-dashed border-red-300 rounded-lg flex flex-col items-center justify-center gap-2 py-10 md:py-12 mb-6 cursor-pointer hover:bg-red-50 text-center px-2">
                  ...
                  <span className="bg-red-500 text-white px-4 py-2 rounded-lg text-sm font-semibold flex items-center gap-2">
                    <UploadCloud size={16} />
                    Choose Files
                  </span>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    type="button"
                    onClick={() => setStep(1)}
                    className="w-full sm:w-1/2 border border-red-300 text-red-600 py-3 rounded-lg font-semibold hover:bg-red-50"
                  >
                    ← Back to Details
                  </button>
                  ...
                  <button
                    type="button"
                    onClick={() => setStep(3)}
                    className="w-full sm:w-1/2 bg-red-500 text-white py-3 rounded-lg font-semibold hover:bg-red-600"
                  >
                    Continue to Review →
                  </button>
              ...
              <div>
                ...
                <div className="border border-gray-200 rounded-lg p-4 mb-4">
                  ...
                  <div className="flex justify-between items-center mb-2">
                    ...
                    <button
                      type="button"
                      onClick={() => setStep(1)}
                      className="text-red-600 text-xs border border-blue-300 px-3 py-1 rounded-lg"
                    >
                      ✎ Edit
                    </button>
                ...
                <div className="flex flex-col sm:flex-row gap-3">
                  ...
                  <button
                    ...
                    disabled={submitting}
                    className="w-full sm:w-1/2 bg-red-500 text-white py-3 rounded-lg font-semibold hover:bg-red-600 flex items-center justify-center gap-2 disabled:opacity-60 disabled:cursor-not-allowed"
                  >
          ...
          <div className="flex flex-col gap-4">
              ...
              <div className="bg-red-50 p-6 rounded-xl">
                ...
                <ul className="text-sm text-gray-600 space-y-3">
                  ...
                  <li>
                    ...
                    <br />
                    More details = higher chance of finding your item.
                  </li>
            ...
            <div className="bg-red-50 p-6 rounded-xl">
              ...
              <button
                type="button"
                className="w-full border border-red-300 text-red-600 py-2 rounded-lg text-sm font-semibold hover:bg-red-100"
              >
                Contact Support ↗
              </button>
